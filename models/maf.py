...
class MaskedAutoregressiveFlow(nn.Module):
    ...
    def setup(self):
        ...
        self.sample_dist = distrax.MultivariateNormalDiag(jnp.zeros(self.n_dim), jnp.ones(self.n_dim)*0.1)
    ...
    def sample2(self, num_samples: int, rng: Array, context: Array = None) -> Array:
        return self.flow.sample2(seed=rng, sample_shape=(num_samples,), context=context)
